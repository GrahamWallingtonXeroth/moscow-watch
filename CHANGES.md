...
| --- | ---: | ---: | ---: | ---: | --- |
| Russia-Iran engagement volume (reporting index) | 0.26 | 0.5 | +0.23 | 26 h | toward H1, H4; away from H3, H5 |
...
No resolution wording changed and no new markets appeared in a tracked series.
